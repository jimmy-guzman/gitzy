import type { BranchFlags, CommitFlags, SquashFlags } from "@/cli/types";
...
type SquashFlagDescriptions = Record<keyof Omit<SquashFlags, "emoji">, string>;
